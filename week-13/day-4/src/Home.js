const Home = (props) => {
    const { title, price, beds, baths, pets, image, reviews, rating } = props;
    ...
    return (
        <div
            ...
            <div class="w-full md:w-auto">
                <div class="aspect-square w-full md:w-48 flex-shrink-0 flex-grow-0 bg-zinc-200 rounded-2xl bg-center bg-cover"
                    style={{
            ...
            <div class="w-full">
                <div class="flex justify-between text-lg md:text-xl flex-col md:flex-row">
                    <div class="font-semibold text-zinc-800 mt-4 md:mt-0">{title}</div>
                    <div class="text-rose-500 font-semibold mt-1 md:mt-0">${price}/week</div>
                </div>
                <div
                ...
                <div
                    ...
                    <div class="flex gap-1 md:gap-2 text-zinc-600 text-sm md:text-base">
                        <i class="fa-solid fa-star leading-6 text-yellow-400"></i> <span
                            class="leading-7">{rating}&nbsp;({reviews}&nbsp;reviews)</span>
                    </div>
                    <div class="w-full md:w-auto">
                        <button
